...
def main():
    ...
    floorsettings = {
        ...
        "length_x":  int(window.localStorage.getItem("apartementSize")),
...
def update():
    ...
    global original_room, floor_length_y, floor_ratio, floor_iterations

    floor_length_x = int(window.localStorage.getItem("apartmentSize"))
    floor_length_y = int(window.localStorage.getItem("apartmenSize"))
    ...
    #update room when changing ratios in local storage
    if int(window.localStorage.getItem("apartementSize")) != floor_length_x or floor_length_y:
        original_room = []
        floor_length_y = int(window.localStorage.getItem("apartmentSize"))
        update_room = define_room((p1_x, p1_y, p2_x, p2_y,)p3_x, p3_y, p4_x, p4_y)
  
        update_room = define_room(floorsettlength_x, -0.5*floorsettings.length_y, 0.5*floorsettings.length_x, -0.5*floorsettings.length_y, 0.5*floorsettings.length_x , 0.5*floorsettings.length_y, -0.5*floorsettings.length_x, 0.5*floorsettings.length_y)
